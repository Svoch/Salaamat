 ...
 *
 */
public class DoctorViewAllRequestsPage extends JFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public DoctorViewAllRequestsPage() {
	        ...
	        if (mouseEvent.getClickCount() == 2) {
	          ...
	          if (index >= 0) {
	            ...
	            EventQueue.invokeLater(new Runnable() {
	    			public void run() {
	    				try {
	    					DoctorViewPatientWithRequestPage frame = new DoctorViewPatientWithRequestPage((Patient)o);
	    					frame.setVisible(true);
	    				} catch (Exception e) {
	    					e.printStackTrace();
	    				}
